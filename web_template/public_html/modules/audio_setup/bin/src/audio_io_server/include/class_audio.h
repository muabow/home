...
class AUDIO_Handler {
	...
	public  :
		...
		int 			update_databse_status(string _type, string _field, string _value, string _format);
		int 			update_databse_status(string _type, string _field, string _value);
		int 			update_databse_status(string _type, string _field, int _value);
		...
		int				query(string _table, string _query);
};
...
class TTS_Handler {
	private :
		...
		string 			str_tts_file;
		string 			str_chime_begin;
		string 			str_chime_end;
		string 			str_current_set;

		string 			str_tts_info;

	public  :
		TTS_Handler(bool _is_debug_print = false);
		~TTS_Handler(void);
		...
		void			set_tts_play_status(bool _status);
		void			set_tts_index(int _idx);
		void			set_tts_file(string _name);
		void			set_tts_info(string _name);
		void 			set_tts_chime(string _type, string _name);

		int 			get_tts_index(void);
		string 			get_tts_info(void);
		bool			is_tts_play_status(void);
