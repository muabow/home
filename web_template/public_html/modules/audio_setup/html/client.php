		...
		<div class="div_contents_cell_line" id="div_redundancy_status">
			...
			<div class="div_contents_cell_contents">
				<div class="div_contents_radio_wrap">
					...
					<label class="label_class_radio" for="radio_client_redundancy_master"><?=Audio_setup\Lang\STR_CLIENT_REDUNDANCY_MASTER ?></label>
				</div>

				<div class="div_contents_radio_wrap">
					<input class="input_class_radio" type="radio" name="radio_client_redundancy" id="radio_client_redundancy_slave" />
					<label class="label_class_radio" for="radio_client_redundancy_slave"><?=Audio_setup\Lang\STR_CLIENT_REDUNDANCY_SLAVE ?></label>
				</div>
							...
							<div class="div_contents_table_box_wrap">
								<div class="div_contents_table_box">
									<div class="div_contents_textbox">
										...
										<label for="input_client_ip_addr_multicast"><?=Audio_setup\Lang\STR_COMMON_IP_ADDR ?></label>
									</div>
								</div>
								...
								<div class="div_contents_table_box">
									<div class="div_contents_textbox">
										...
										<label for="input_client_port_multicast"><?=Audio_setup\Lang\STR_COMMON_PORT ?></label>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="div_contents_table_box_wrap">
								<div class="div_contents_table_box">
									<div class="div_contents_textbox">
										...
										<label for="input_client_ip_addr_master"><?=Audio_setup\Lang\STR_COMMON_IP_ADDR ?></label>
									</div>
								</div>
					...
					<div class="div_contents_cell_row_wrap">
						...
						<div class="div_contents_cell_column_wrap">
							...
							<div class="div_contents_table_box_wrap">
								<div class="div_contents_table_box">
									<div class="div_contents_textbox">
										<label for="input_client_ip_addr_slave"><?=Audio_setup\Lang\STR_COMMON_IP_ADDR ?></label>
