				...
				init : function(options) {
					...
					var eqCol = $(eqCols, eqWrap), eqItem = $(eqItem, eqWrap), randomNumber = function(m, n) {
						...
						eqCol.each(function() {
							...
							var parentName  = $(this).parent().attr("class").split(" ");
							var index		= parentName[0].split("_")[1];

							var thisName = $(this).attr("class").split("_")[1];
							var volume   = parseInt($(".level_" + thisName + "_" + index).html()) + 1;
