 ...
 *********************************************************************************************/
#ifndef __MP3_DEC_INTERFACE_H__
#define __MP3_DEC_INTERFACE_H__
...
#define MAX_FRAME_SIZE                    (2881+8)   //Mpeg2.5 LayerII, 8KHz, 160kbps, padding slot
#define BS_PROTECT                        8
...
void *AllocFast(int size);
void *AllocSlow(int size);
