...
<div id="div_contents">
	...
	<div id="div_contents_table">
		...
		<div class="div_contents_cell">
			...
			<div class="div_contents_cell_line" style="<?=$str_ext_status ?>" id="div_ext_upload_storage">
				...
				<div class="div_contents_cell_contents">
					<div style="float : left; ">
						<input type="radio" name="radio_upload_case" value="upload_internal" checked="checked" /> <?=Source_file_management\Lang\STR_EXT_SELECT_STORAGE_INTERNAL ?> </input> <br />
			...
			<div class="div_button_wrap">
				...
				<div class="div_upload_avail_size_info"> <?=Source_file_management\Lang\STR_SRCFILE_ADD_AVAILABLE_MEM . " : " ?> </div>
				<div class="div_upload_avail_size_value"> <span id="span_upload_available"></span> Mbytes</div>
				
				<div class="div_upload_avail_size_info"  style="<?=$str_ext_status ?>" name="div_ext_avail_info">| &nbsp; <?=Source_file_management\Lang\STR_EXT_SRCFILE_ADD_AVAILABLE_MEM . " : " ?> </div>
			...
			<span style="padding-left: 10px; font-size: 10pt; font-weight: bolder; <?php echo $status_style_hidden; ?>">* <?=Source_file_management\Lang\STR_HELP_SRC_MODE ?> </span>
		</div>
	</div>
	...
	<div class="div_contents_title" style="<?php echo $status_style_output; ?>">
		<?=Source_file_management\Lang\STR_OPER_INFO ?>
	</div>

	<div class="div_contents_cell" style="margin: 10px 0 20px 0; <?php echo $status_style_output; ?>">
		<div class="div_contents_cell_line">
		...
		<div class="div_contents_cell_line" style="<?php echo $status_style_amp_device; ?>">
			...
			<div class="div_contents_cell_contents" style="width: 615px; padding-top: 10px;">
				<div class="div_contents_cell_column_wrap">
					...
					<div id="div_button_apply_volume" class="div_class_button div_class_button_slider">
