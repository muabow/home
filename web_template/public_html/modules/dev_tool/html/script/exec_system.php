...
<script type="text/javascript">
	class SystemFunc {
		...
		constructor() {
			this.path = "http://<?php echo $_SERVER["HTTP_HOST"]; ?>/modules/dev_tool/html/script/exec_system.php";
		}
...
<div id="system-div_page_title_name"> 시스템 환경 설정 (System preferences) </div>

<hr class="title-hr" style="width: 890px"/>

<div id="system-div_contents_table">
	<div class="system-div_contents_title">
		포트 설정 (Port status setting)
	</div>
	...
	<div class="system-div_contents_cell">
		<div class="system-div_contents_cell_line">
			...
			<div class="system-div_contents_cell_contents">
				<div class="system-textbox">
					<input type="text" id="text_system_port_web" maxlength="5" value="<?php echo getSystemPort("web"); ?>"/>
				</div>
			</div>
		</div>
		...
		<div class="system-div_button_wrap">
			<div class="system-div_button" id="div_buttonApplyPort">
				적용
			</div>
		</div>
	</div>
...
<div id="system-div_contents_table">
	...
	<div class="system-div_contents_cell">
		<div class="system-div_contents_cell_line">
			...
			<div class="system-div_contents_cell_contents">
				<div class="system-div_system_toggle <?=getServiceSSHOperation() ?>" id="toggle_ssh">
					<span class="system-span_system_check_on"> ON </span>
					<span class="system-span_system_check_off"> OFF </span>
					<div class="system-div_system_check_toggle <?=getServiceSSHToggle() ?>" id="check_ssh"></div>
				</div>
			</div>
		</div>
		<div class="system-div_contents_cell_line"></div>

		<span style="padding-left: 10px; font-weight: bold; font-size: 13px;"> * 장치 재부팅 시 초기값(OFF)으로 설정됩니다. </span>
	</div>
</div>

<div id="system-div_contents_table">
	<div class="system-div_contents_title">
		언어팩 설정 (Language pack setting)
	</div>
