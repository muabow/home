...
<link rel="stylesheet"	href="<?=Log_viewer\Def\PATH_WEB_CSS_STYLE     ?>" type="text/css" />
...
<div id="div_contents_log_viewer">
	...
	<div id="div_log_banner">
		...
		<div id="div_log_remove" class="div_log_button"> <?=Log_viewer\Lang\STR_LOG_REMOVE ?> </div>
		<div id="div_log_download" class="div_log_button"> <?=Log_viewer\Lang\STR_LOG_DOWNLOAD ?> </div>
	</div>

	<div id="div_log_form" class="ui-widget-content">
