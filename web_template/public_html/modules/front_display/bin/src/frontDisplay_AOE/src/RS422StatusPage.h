#ifndef __RS422_STATUS_PAGE_H__
#define __RS422_STATUS_PAGE_H__
...
class RS422StatusPage : public AbstractPage {
public:

	RS422StatusPage() throw (const char*)
		: _headerCanvas(HEADER_WIDTH, HEADER_HEIGHT)
		, _bodyCanvas(BODY_WIDTH, BODY_HEIGHT)
	{};
	virtual ~RS422StatusPage() throw (const char*) {};
...
const std::string RS422StatusPage::SERVER_PROCESS = "serial_422_s";
const std::string RS422StatusPage::CLIENT_PROCESS = "serial_422_c";


#endif	// __RS422_STATUS_PAGE_H__
