#ifndef __PIO_STATUS_PAGE_H__
#define __PIO_STATUS_PAGE_H__
...
class PIOStatusPage : public AbstractPage {
public:

	PIOStatusPage() throw (const char*)
		: _headerCanvas(HEADER_WIDTH, HEADER_HEIGHT)
		, _bodyCanvas(BODY_WIDTH, BODY_HEIGHT)
	{};
	virtual ~PIOStatusPage() throw (const char*) {};
...
const std::string PIOStatusPage::SERVER_PROCESS = "contact_ser";
const std::string PIOStatusPage::CLIENT_PROCESS = "contact_cli";


#endif	// __PIO_STATUS_PAGE_H__
