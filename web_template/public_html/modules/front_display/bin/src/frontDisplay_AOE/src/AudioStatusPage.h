#ifndef __AUDIO_STATUS_PAGE_H__
#define __AUDIO_STATUS_PAGE_H__
...
class AudioStatusPage : public AbstractPage {
public:

	AudioStatusPage() throw (const char*)
		: _headerCanvas(HEADER_WIDTH, HEADER_HEIGHT)
		, _bodyCanvas(BODY_WIDTH, BODY_HEIGHT)
	{};
	virtual ~AudioStatusPage() throw (const char*) {};
...
const std::string AudioStatusPage::SERVER_PROCESS = "audio_server";
const std::string AudioStatusPage::CLIENT_PROCESS = "audio_client";


#endif	// __AUDIO_STATUS_PAGE_H__
