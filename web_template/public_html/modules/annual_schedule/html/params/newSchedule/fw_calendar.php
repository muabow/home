...
$list_mp3 = array();
if (!$handle = @opendir("/opt/interm/public_html/modules/annual_schedule/html/data/files")){
}
else{
    $cnt = 0;
...
<link rel="stylesheet" href='modules/annual_schedule/html/params/newSchedule/full/jquery/jquery-ui.css'>
<link rel="stylesheet" href='modules/annual_schedule/html/params/newSchedule/full/jquery/jquery-ui-timepicker-0.2.9/jquery.ui.timepicker.css'>
<script type='text/javascript' src='modules/annual_schedule/html/params/newSchedule/full/jquery/jquery-ui.min.js'></script>
<script type='text/javascript' src='modules/annual_schedule/html/params/newSchedule/full/simple_colorpicker.js'></script>
<script type='text/javascript' src='modules/annual_schedule/html/params/newSchedule/full/jquery/jquery-ui-timepicker-0.2.9/jquery.ui.timepicker.js'></script>
...
PopupTitle = '<?php echo Annual_schedule\Lang\SIBO_MAIN_15?>';
PopupTitleCopy = '<?php echo Annual_schedule\Lang\COPY_PASTE_STR?>';
m = 'cal';
...
str_hour = '<?php echo Annual_schedule\Lang\SIBO_HOUR_STR?>';
str_minute = '<?php echo Annual_schedule\Lang\SIBO_MINUTE_STR?>';
str_now = '<?php echo Annual_schedule\Lang\SIBO_NOW_STR?>';
str_save = '<?php echo Annual_schedule\Lang\SIBO_MAIN_10?>';
str_remove = '<?php echo Annual_schedule\Lang\RADIO_USER_DEL?>';

str_holiday = '<?php echo Annual_schedule\Lang\DISPLAY_HOLIDAY?>';
str_download = '<?php echo Annual_schedule\Lang\DISPLAY_DOWNLOAD?>';
str_upload = '<?php echo Annual_schedule\Lang\DISPLAY_UPLOAD?>';
str_copy = '<?php echo Annual_schedule\Lang\DISPLAY_MONTHCOPY?>';
str_today = '<?php echo Annual_schedule\Lang\DISPLAY_TODAY?>';
str_copy_only = '<?php echo Annual_schedule\Lang\COPY_STR?>';

str_monthly = '<?php echo Annual_schedule\Lang\DISPLAY_MONTH ?>';
str_weekly = '<?php echo Annual_schedule\Lang\DISPLAY_WEEK ?>';
str_daily = '<?php echo Annual_schedule\Lang\DISPLAY_DAY ?>';
str_yearly = '<?php echo Annual_schedule\Lang\DISPLAY_YEAR ?>';
str_close = '<?php echo Annual_schedule\Lang\SIBO_CLOSE?>';
str_delete_confirm = '<?php echo Annual_schedule\Lang\SIBO_DELETE_STR?>';
...
<script type='text/javascript' src='modules/annual_schedule/html/params/newSchedule/full/fullcalendar/lib/moment.min.js'></script>
<script type='text/javascript' src='modules/annual_schedule/html/params/newSchedule/fw_events.js?v=2019040429'></script>
<script type='text/javascript' src='modules/annual_schedule/html/params/newSchedule/full/fullcalendar/fullcalendar.js'></script>

<link rel="stylesheet" href='modules/annual_schedule/html/params/newSchedule/full/fullcalendar/fullcalendar.css' rel='stylesheet'>
<link rel="stylesheet" href='modules/annual_schedule/html/params/newSchedule/full/fullcalendar/fullcalendar.print.css' rel='stylesheet' media='print'>
...
<div id="dialog-message" title="Agenda-item toevoegen" style="display: none;background-color:gray;font-weight:bold;">
	<form>
		<div style="text-align:right;">
			<div style="margin-left:10px;height:20px;text-align:left;"><?php echo Annual_schedule\Lang\SIBO_NAME?></div>
			<textarea cols="30" rows="1" id="edited_title" style="width:98%;resize:none;" maxlength="64"></textarea>
			<div style="height:5px;">&nbsp;</div>
			<div style="width:100%;text-align:right;">
				<table style="width:100%;margin-right:10px;border:1px;"><tr><td><?php echo Annual_schedule\Lang\DATE_TYPE_STR?><br />
				...
				<div style="margin-bottom: 5px;">
					<span style="float:right;"><?php echo Annual_schedule\Lang\SIBO_DATE_STR?>
				...
				<div style="margin-bottom: 5px;">
					<span style="float:right;"><?php echo Annual_schedule\Lang\SIBO_TIME_STR?>
			...
			<div style="float:right"><input type="checkbox" id="dow_0" value='0' style="vertical-align: middle;" onclick="javascript:dow_click();"><label for="dow_0"><?php echo Annual_schedule\Lang\SIBO_CENTER_STR6?> </label>
			<input type="checkbox" id="dow_1" value='1' style="vertical-align: middle;" onclick="javascript:dow_click();"><label for="dow_1"><?php echo Annual_schedule\Lang\SIBO_CENTER_STR7?> </label>
			<input type="checkbox" id="dow_2" value='2' style="vertical-align: middle;" onclick="javascript:dow_click();"><label for="dow_2"><?php echo Annual_schedule\Lang\SIBO_CENTER_STR8?> </label>
			<input type="checkbox" id="dow_3" value='3' style="vertical-align: middle;" onclick="javascript:dow_click();"><label for="dow_3"><?php echo Annual_schedule\Lang\SIBO_CENTER_STR9?> </label>
			<input type="checkbox" id="dow_4" value='4' style="vertical-align: middle;" onclick="javascript:dow_click();"><label for="dow_4"><?php echo Annual_schedule\Lang\SIBO_CENTER_STR10?> </label>
			<input type="checkbox" id="dow_5" value='5' style="vertical-align: middle;" onclick="javascript:dow_click();"><label for="dow_5"><?php echo Annual_schedule\Lang\SIBO_CENTER_STR11?> </label>
			<input type="checkbox" id="dow_6" value='6' style="vertical-align: middle;" onclick="javascript:dow_click();"><label for="dow_6"><?php echo Annual_schedule\Lang\SIBO_CENTER_STR12?> </label></div>
			<div style="clear:both;"></div>
			<div>
				<input type="radio" name="repeat_radio" id="repeat_everyday_checkbox" style="vertical-align: middle;" />
				<label for="repeat_everyday_checkbox"><?php echo Annual_schedule\Lang\REPEAT_EVERYDAY_STR?></label>
				<input type="radio" name="repeat_radio" id="repeat_once_checkbox" checked style="vertical-align: middle;" />
				<label for="repeat_once_checkbox"><?php echo Annual_schedule\Lang\REPEAT_ONCE_STR?></label>
				<input type="checkbox" id="allday_checkbox" value='1' style="vertical-align: middle;margin-top:3px;">
				<label for="allday_checkbox"><?php echo Annual_schedule\Lang\SIBO_ALLDAY_STR?></label>
			</div>
			<div style="margin:1px 0 0 0;text-align: left;">
				<span class="dialog_formfield" id="ColorPicker1"></span>
				<?php echo Annual_schedule\Lang\SIBO_FILE_SELECT?><span id="ColorSelectionTarget1">&nbsp;</span>
			</div>
			<div style="height:5px;">&nbsp;</div>
			<div>
				<input type="checkbox" id="edited_autoplayback" value='1' style="vertical-align: middle;">
				<label for="edited_autoplayback"><?php echo Annual_schedule\Lang\SIBO_AUTOEND_STR?></label>
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo Annual_schedule\Lang\MSG_REP_STR?>
				<select id="edited_repeat" onchange="RepeatChange()">
					<option value=""><?php echo Annual_schedule\Lang\SIBO_NONE_STR?></option>
					<option value="week"><?php echo Annual_schedule\Lang\SIBO_WEEK_STR?></option>
					<option value="month"><?php echo Annual_schedule\Lang\SIBO_MONTH_STR?></option>
					<option value="year"><?php echo Annual_schedule\Lang\SIBO_YEAR_STR?></option>
				</select>
				<select id="enable_week">
					<option value="every"><?php echo Annual_schedule\Lang\SIBO_EVERYWEEK_STR?></option>
					<option value="first"><?php echo Annual_schedule\Lang\SIBO_FIRSTWEEK_STR?></option>
					<option value="last"><?php echo Annual_schedule\Lang\SIBO_LASTWEEK_STR?></option>
				</select>
			</div>
			<div>--------------------------------------------------------------</div>
			<div style="margin:5px 0 5px 0;">
				<?php echo Annual_schedule\Lang\SIBO_ACTIONTYPE_STR?>
				...
				<?php echo Annual_schedule\Lang\SIBO_REPEAT_CNT_STR?>
				<input type="text" id="edited_repeat_count" style="width: 40px;" class="ed" maxlength="3" />
			</div>
			<div id="file_area">
				<div style="margin-left:10px;height:20px;text-align:left;"><?php echo Annual_schedule\Lang\SIBO_FILENAME_STR?></div>
            ...
            <div id="script_area">
				<textarea cols="32" rows="6" id="edited_script" style="width:97%;resize:none;" maxlength="256"></textarea>
            </div>
			<div id="no_action">
				<textarea cols="30" rows="1" style="width:95%;resize:none;background-color:gray;border-color:gray;" maxlength="16" readonly='readonly'><?php echo Annual_schedule\Lang\SIBO_NOTSUPPORTED_STR?></textarea>
			</div>
			<div>--------------------------------------------------------------</div>
...
<div id="dialog-copy" title="Agenda-item toevoegen" style="display: none;background-color:gray;font-weight:bold;">
	<form>
		<div style="text-align:right;">
			<div style="margin-left:10px;height:20px;text-align:left;"><?php echo Annual_schedule\Lang\SIBO_COPY_NAME?></div>
			<div style="height:5px;">&nbsp;</div>
		</div>
		<textarea cols="30" rows="1" id="copy_title" style="width:98%;resize:none;" maxlength="64"></textarea>
		<hr style="border: solid 1px #666666"><?php echo Annual_schedule\Lang\SIBO_COPY_TARGETDATE?></hr>
		<div style="vertical-align: top left;margin-top:3px;"><input type="text" style="width:200px;" id="add_sche_datepicker" /><div id="add_schedule" style="margin-left:3px;"><?php echo Annual_schedule\Lang\COPY_STR?></div><div id="remove_schedule" style=""><?php echo Annual_schedule\Lang\RADIO_USER_DEL?></div></div>
		<hr style="border: dashed 1px #666666;margin-top:3px;" />
		<div><?php echo Annual_schedule\Lang\SIBO_COPY_COPYEDDATE?></div>
...
<script type="text/javascript">
	...
	$("#date_format").change(function() {
		...
		$.ajax({
				type:"POST",
				url: "/modules/annual_schedule/html/params/newSchedule/fw_events.php?action=setDateFormat",
				data: dataString,
	...
	function FileSelect(){
		...
		if (action_type == "MP3 Play"){
			...
			$.ajax({
				type:"POST",
				url: "/modules/annual_schedule/html/params/newSchedule/fw_events.php?action=dur",
				data: dataString,
				success:function(html){
					if (html == "no file."){
